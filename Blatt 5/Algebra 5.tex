...
\end{bem}
\begin{proof}
 Sei $\tau = (1 \; 2) \in \Sn_n$ und $\varphi$ die Linkstranslation mit $\tau$. Aufgrund der Injektivität von $\varphi$ induziert $\varphi$ eine injektive Abbildung von der Menge aller gerader Permutation $\mf{A}$ in die Menge aller ungerader Permutationen $\Sn_n - \mf{A}_n$, sowie eine injektive Abbildung von $\Sn_n-\mf{A}_n$ nach $\mf{A}$. Da $\varphi$ involutiv ist, ist es auch die induzierte Abbildung, also 
 \[
  \ord \mf{A}_n = |\Sn_n - \mf{A}_n| = \ord \Sn_n - \ord \mf{A}_n,
 \]
 da $\Sn_n$ endlich ist, und somit $\ord \Sn_n = 2 \ord \mf{A}_n$.
\end{proof}
...
\begin{proof}[Beweis der Behauptung]
 Als Ideal ist $\mf{a}$ eine Untergruppe von der additiven Gruppe von $R$, sowie unter Multiplikation abgeschlossen, wobei sich Assoziativität, Kommutativität und Distributivität der Multiplikation von $R$ auf $\mf{a}$ vererben. Aus der entsprechenden Eigenschaft von $R$ folgt, dass $\mf{a}$ ein Ring mit Einselement bildet. Aus Bemerkung \ref{bem: 1 ohne nullteiler eindeutig} folgt damit, dass $1 \in \mf{a}$, und daher bereits $\mf{a} = R$.
\end{proof}
